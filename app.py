...
RESPONSE_DATA = {
    ...
    "contact_creator": [
        "📬 You can contact me here: [Fill out this Google Form](https://docs.google.com/forms/d/e/1FAIpQLSfXXXXXXXXXXXXXXX/viewform)",
        "Want to talk to Aylin? Fill this out: [Google Form](https://docs.google.com/forms/d/e/1FAIpQLSfXXXXXXXXXXXXXXX/viewform)",
    ],
    "user_feeling_bad": [
